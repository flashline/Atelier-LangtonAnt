...
Driver.maxStep=-1; 					// max step number before stop or -1 for infinite
Driver.frequency=100;					// Number of frame per second
...
initColorChain=initColorChain14; 	// Choose one of the functions below
